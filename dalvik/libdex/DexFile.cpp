...
u4 dexRoundUpPower2(u4 val)
{
	...
	//假设val 56  
	//55 00110111
	//00110111 | 00011011 =  00111111
	//00111111 | 00001111 =  00111111
	//自己动手用几个数试下
	//其实就是位运算只管首位，首位会把后面的位都设置成1根本不关心后面为是不是1
	//例前八位 	        01000000 >> 1 = 00100000
	//     			01100000 >> 2 = 00011000
	//     			01111000 >> 4 = 0000011110000000
	//				01111111 10000000 >> 8 = 00000000 01111111 10000000 00000000
	//				01111111 11111111 10000000         00000000 >> 16 = 00000000 00000000 01111111 11111111
	//				01111111 11111111 11111111 11111111
	//最后+1          10000000 00000000 00000000 00000000	
    val--;
    val |= val >> 1;
    val |= val >> 2;
    val |= val >> 4;
