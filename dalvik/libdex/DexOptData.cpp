...
bool dexParseOptData(const u1* data, size_t length, DexFile* pDexFile)
{
    ...
    while (*pOpt != kDexChunkEnd) {
         ...
         */
        //https://zhidao.baidu.com/question/1704099990419179620.html
        //roundedSize是 sise + 8在7+1的倍数中的最小上界
        //假设size = 2, roundedSize等于8的倍数中最小且大于2+8即16
        //说实话，看吐了，但是理解了含义真的觉得位运算很巧妙
